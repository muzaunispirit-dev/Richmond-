  ...
  return (
    <section className="bg-[#12110f]">
      ...
      <div className="relative h-[50vh] min-h-[360px] overflow-hidden md:h-[60vh]">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#12110f] via-[#12110f]/60 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#12110f] to-transparent" />
          ...
          <div className="grid gap-12 md:grid-cols-12 md:gap-16">
            ...
            <Reveal className="md:col-span-5" stagger>
              <div className="border-t border-white/10 pt-8">
                <p className="mb-1 text-[10px] tracking-[0.3em] text-[#c9a96e]/70">
                  OUR LOCATION
                </p>
