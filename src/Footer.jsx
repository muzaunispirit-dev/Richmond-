      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-12 md:grid-cols-4 md:gap-8">
          ...
          {FOOTER_LINKS.map((group) => (
            <div key={group.group}>
              <p className="mb-4 text-[10px] tracking-[0.3em] text-[#221b14]/45">
              ...
              <div className="flex flex-col gap-2.5">
                {group.links.map((link) => (
                  <a
                    key={link}
                    href="#"
                    className="text-[13px] text-[#221b14]/60 transition-colors hover:text-[#221b14]"
                  >
                    {link}
                  </a>
                ))}
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5 text-[13px] text-[#221b14]/60">
              <a href="tel:+919986197711" className="hover:text-[#221b14]">
                +91 99861 97711
              </a>
              <a
                href="mailto:nayazsheriff@richmondsuites.in"
                className="hover:text-[#221b14]"
              >
                nayazsheriff@richmondsuites.in
              </a>
              <p className="mt-1 leading-relaxed text-[#221b14]/45">
                Richmond Town
                <br />
                Bengaluru, Karnataka
              </p>
